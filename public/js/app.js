...
function initAdmin(socket) {
  var orderTableBody = document.querySelector('#orderTableBody'); //to get order table body from order.ejs
...
var addToCart = document.querySelectorAll('.add-to-cart'); //array of add to cart button
...
function updateCart(pizza) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/update-cart', pizza).then(function (res) {
    ...
    new noty__WEBPACK_IMPORTED_MODULE_1___default.a({
      type: 'success',
      // for green successsful colour
      timeout: 1000,
      // after how much time it dissapears in millisec
      text: 'Item added to cart',
      progressBar: false //layout:'bottomCenter' //to position notifiaction place
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    ...
    var pizza = JSON.parse(btn.dataset.pizza); //to convert it into object agai  parse is used...opposite of stringify
...
function updateStatus(order) {
  ...
  var stepCompleted = true; // in starting first line is gray by default
  ...
  statuses.forEach(function (status) {
    ...
    if (dataProp === order.status) {
      ...
      if (status.nextElementSibling) {
        //for last stage there won't be next state therefore if condition to check
...
var socket = io(); // got from server ..code in layout.ejs --script tag
...
socket.on('orderUpdated', function (data) {
  var updatedOrder = _objectSpread({}, order); // to copy object in js use three dots to copy object
...
__webpack_require__(/*! C:\Users\ARUN KUMAR SINGH\Desktop\projects\pizza-order\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\ARUN KUMAR SINGH\Desktop\projects\pizza-order\resources\scss\app.scss */"./resources/scss/app.scss");
